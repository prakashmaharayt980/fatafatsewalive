...
import { Copy, Check, Mail, Smartphone, Share2, Link } from "lucide-react";
...
export default function ShareDialog({
    ...
    const shareLinks = [
        {
            name: "Facebook",
            icon: <Image src={facebookIcon} alt="Facebook" width={24} height={24} className="w-5 h-5 fill-blue-600 text-blue-600" />,
            url: `https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(productUrl)}`,
            color: "hover:bg-blue-50 border-blue-100/50"
        },
        {
            name: "Twitter",
            icon: <Image src={twitterIcon} alt="Twitter" width={24} height={24} className="w-5 h-5 fill-sky-500 text-sky-500" />,
