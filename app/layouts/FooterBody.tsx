              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex gap-2">
                  <a href="#" className="block hover:opacity-80 transition-opacity">
                    <Image src={playStore} alt="Google Play Store" width={120} height={36} className="h-9 w-auto" />
                  </a>
                  <a href="#" className="block hover:opacity-80 transition-opacity">
                    <Image src={appStore} alt="App Store" width={120} height={36} className="h-9 w-auto" />
                  </a>
                </div>
              </div>
