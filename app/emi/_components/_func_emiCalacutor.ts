...
export const BANK_PROVIDERS: BankProvider[] = [
    { id: 'nabil', name: 'Nabil Bank', rate: 11.5, img: allPartners.banks.bank7, tenureOptions: [12, 18, 24, 36] },
    { id: 'global', name: 'Global IME Bank', rate: 12, img: allPartners.banks.bank1, tenureOptions: [12, 24, 36] },
    { id: 'nmb', name: 'NMB Bank', rate: 11.75, img: allPartners.banks.bank3, tenureOptions: [12, 24, 36] },
    { id: 'siddhartha', name: 'Siddhartha Bank', rate: 12.25, img: allPartners.banks.bank9, tenureOptions: [12, 24, 36] },
    { id: 'NicAsia', name: 'Nic Asia Bank', rate: 12.25, img: allPartners.banks.bank11, tenureOptions: [12, 24, 36] },
    { id: 'hbl', name: 'Himalayan Bank', rate: 12.25, img: allPartners.banks.bank10, tenureOptions: [12, 24, 36] },
    { id: 'sanimabank', name: 'Sanima Bank', rate: 12.25, img: allPartners.banks.bank8, tenureOptions: [12, 24, 36] },
    { id: 'kumari', name: 'Kumari Bank', rate: 12.25, img: allPartners.banks.bank6, tenureOptions: [12, 24, 36] },
];
