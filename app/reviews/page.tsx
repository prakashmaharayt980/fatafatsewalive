...
import mi10iImg from '@/public/imgfile/mi10iproduct.jpg';

// Mock Data
const ALL_REVIEWS = [
    {
        id: 1,
        user: { name: 'Aarav Sharma', avatar: menpersonIcon },
        rating: 5,
        date: '2 Oct 2024',
                                        ...
                                        <div className="flex gap-2 mt-1">
                                            {review.images.map((img, idx) => (
                                                <div key={idx} className="w-24 h-24 rounded-2xl overflow-hidden border border-gray-100">
                                                    <Image src={img} alt="Review" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
                                                </div>
                                            ))}
                                        </div>
                                    )}
