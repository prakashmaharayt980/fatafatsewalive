...
import gift1 from "@/public/imgfile/gift1.png";
import gift2 from "@/public/imgfile/gift2.png";
...
export default function ReviewDialog({
    ...
    const customerPhotos: (string | StaticImageData)[] = reviews?.data?.flatMap(r => r.images || []) || [];
    // Fallback/Mock photos if none exist, just to show the UI as requested (can be removed later)
    if (customerPhotos.length === 0) {
        customerPhotos.push(gift1, gift2);
    }
