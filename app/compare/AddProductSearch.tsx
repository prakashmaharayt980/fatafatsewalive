...
export default function AddProductSearch({ onSelect, excludeSlugs }: AddProductSearchProps) {
    ...
    return (
        <>
            ...
            {isOpen && (
                <div
                    className="fixed inset-0 z-50 flex items-start justify-center pt-16 sm:pt-20 px-4 bg-black/60 backdrop-blur-md animate-fade-in"
                    onClick={handleClose}
                >
                    {/* Dialog Container - Premium Card Style */}
                    <div
                        className="w-full max-w-2xl bg-white rounded-3xl shadow-2xl flex flex-col max-h-[85vh] animate-slide-down overflow-hidden"
