                        ...
                        {products.map(product => {
                            ...
                            return (
                                <div
                                    ...
                                    className="group flex flex-col bg-white rounded-2xl border border-gray-100 hover:border-gray-200 hover:shadow-[0_8px_32px_rgba(0,0,0,0.08)] transition-all duration-300 cursor-pointer overflow-hidden h-full"
                                >
                                    ...
                                    <div className="flex flex-col flex-1 p-3.5 pt-3">
                                        ...
                                        <p className="text-[13px] font-bold text-gray-800 leading-snug line-clamp-2 min-h-[36px] mb-1.5 group-hover:text-[var(--colour-fsP2)] transition-colors">
                                            {product.name}
                                        </p>
