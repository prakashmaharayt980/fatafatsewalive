...
import screenDamage from '@/public/imgfile/mock-inspection/screen-damage.png'
import backPanelCrack from '@/public/imgfile/mock-inspection/back-panel-crack.png'
import batteryWear from '@/public/imgfile/mock-inspection/battery-wear.png'
...
const MOCK_PARTS = [
    ...
    },
    {
        ...
        repairCost: 1200,
        damageImg: backPanelCrack,
        replacement: { name: 'OEM Back Glass Panel', status: 'Replaced', img: backPanelCrack },
    },
    {
        part: 'Battery',
    ...
    },
    {
        ...
        repairCost: 300,
        damageImg: screenDamage,
        replacement: { name: 'Port Cleaning + Sealant', status: 'Serviced', img: batteryWear },
    },
]
...
function SuccessPageContent() {
    ...
    const p = {
        ...
        image: searchParams.get('image') || (logoImg as any),
