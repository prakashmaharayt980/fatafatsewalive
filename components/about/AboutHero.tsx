...
export default function AboutHero({ bannerData }: AboutHeroProps) {
    ...
    const SocaiMediaData = [
        {
            icon: <Image src={facebookIcon} alt="Facebook" width={24} height={24} className="w-7 h-7 text-blue-600" />,
            value: '475K+',
            label: 'FB Followers',
        ...
        {
            icon: <Image src={instagramIcon} alt="Instagram" width={24} height={24} className="w-7 h-7 text-pink-600" />,
            value: '50K+',
            label: 'IG Followers',
        ...
        {
            icon: <Image src={tiktokIcon} alt="Tiktok" width={24} height={24} className="w-7 h-7 text-slate-800" />,
            value: '80K+',
            label: 'TikTok Fans',
        ...
        {
            icon: <Image src={youtubeIcon} alt="Youtube" width={24} height={24} className="w-7 h-7 text-red-600" />,
            value: '12K+',
            label: 'Subscribers',
