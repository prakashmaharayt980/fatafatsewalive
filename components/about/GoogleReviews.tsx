                ...
                <div className="text-center mb-12">
                    <div className="flex justify-center mb-4">
                        <div className="flex items-center gap-2 bg-white px-4 py-2 border border-slate-200">
                            ...
                            <span className="font-bold text-slate-800">Google Review</span>
                        </div>
                    </div>
                    <h2 className="text-3xl md:text-4xl font-bold text-slate-900 font-heading mb-4">What Our Customers Say</h2>
                    <div className="flex items-center justify-center gap-2">
                        <span className="text-2xl font-bold text-(--colour-fsP1)">4.8</span>
                        <div className="flex gap-1 text-(--colour-fsP1)">
