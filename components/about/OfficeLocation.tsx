...
const OfficeLocation = () => {
    return (
        <section className="py-16 bg-white border-t border-slate-100">
            <div className="container-responsive w-full max-w-7xl mx-auto px-4 md:px-6">
                <div className="flex flex-col lg:flex-row gap-12 items-start">
                    <div className="w-full lg:w-1/3">

                        <h2 className="text-3xl md:text-4xl font-bold text-slate-900 font-heading mb-4">Our Headquarters</h2>
                        <p className="text-slate-600 font-poppins text-base mb-8">
                        ...
                        <div className="space-y-6">
                            <div className="flex items-start gap-4">
                                <div className="p-3 bg-orange-50 text-(--colour-fsP1) shrink-0">
                            ...
                            <div className="flex items-start gap-4">
                                <div className="p-3 bg-blue-50 text-(--colour-fsP2) shrink-0">
                    ...
                    <div className="w-full lg:w-2/3 h-[400px] md:h-[500px] overflow-hidden border border-slate-200 relative">
                        <iframe
