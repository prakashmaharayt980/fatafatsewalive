...
import { Heart, Package, Scale, ShoppingCart, Star } from 'lucide-react';
...
function useProductCard(product: ProductCardProps['product']) {
    ...
    const discountedPrice = 'discounted_price' in product ? Number(product.discounted_price) : 0;
    const displayPrice = (discountedPrice || originalPrice)?.toLocaleString() || '0';
    ...
    return {
        ...
        originalPrice, discountedPrice, displayPrice, discount, rating,
        imageUrl,
        ...
        >
            ...
            <div className="flex flex-col flex-1 p-3 pt-2.5">
                ...
                <div className="mt-auto pt-2">
                    ...
                    {p.originalPrice > 0 && p.discountedPrice > 0 && p.originalPrice > p.discountedPrice && (
                        <p className="text-[11px] text-gray-400 line-through mb-2">
